    ...
    <div className="w-full bg-[#fcfcfd] min-h-screen pt-28 pb-32">
      <div className="container mx-auto px-4 sm:px-6 lg:px-12">
        <nav className="flex items-center text-[10px] font-bold uppercase tracking-[0.2em] text-zinc-400 gap-3 mb-12">
          ...
          <span className="w-1 h-1 rounded-full bg-zinc-300"></span>
          <span className="text-[#D4A373]">Serpong</span>
        </nav>

        <h1 className="text-4xl md:text-6xl font-black text-zinc-900 leading-tight mb-8 tracking-tighter">
          Palet Plastik <span className="text-[#D4A373]">Serpong.</span>
        </h1>
        
        <div className="prose prose-lg prose-zinc max-w-4xl mb-20 text-zinc-600 font-light">
          <p>
            PT Paletindo Prakarsa Unggul hadir sebagai solusi utama bagi Anda yang membutuhkan <strong>palet plastik Serpong</strong>. Berlokasi strategis di wilayah Tangerang Selatan, kami melayani pengiriman cepat ke seluruh kelurahan di Serpong, termasuk Cilenggang, Lengkong Gudang, hingga kawasan industri di sekitarnya.
          </p>
          <p>
            Kami menyediakan berbagai pilihan pallet industrial, mulai dari tipe <em>Heavy Duty</em> untuk racking gudang hingga tipe <em>Food Grade</em> yang aman untuk industri farmasi dan makanan. Semua produk kami dijamin memiliki durabilitas tinggi dan standar kualitas internasional.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-32">
          <div className="bg-white p-10 rounded-[2.5rem] border border-zinc-100 shadow-sm">
            ...
            <h3 className="text-xl font-bold mb-4">Pengiriman Kilat</h3>
            <p className="text-sm text-zinc-500 leading-relaxed">Hanya 20-30 menit dari gudang pusat kami ke lokasi Anda di Serpong.</p>
          </div>
          <div className="bg-white p-10 rounded-[2.5rem] border border-zinc-100 shadow-sm">
            <ShieldCheck className="w-10 h-10 text-[#D4A373] mb-6" />
            <h3 className="text-xl font-bold mb-4">Kualitas Terjamin</h3>
            <p className="text-sm text-zinc-500 leading-relaxed">Setiap unit melewati proses QC ketat sebelum dikirim ke pelanggan.</p>
          </div>
          <div className="bg-white p-10 rounded-[2.5rem] border border-zinc-100 shadow-sm">
            <Star className="w-10 h-10 text-[#D4A373] mb-6" />
            <h3 className="text-xl font-bold mb-4">Harga Kompetitif</h3>
            <p className="text-sm text-zinc-500 leading-relaxed">Harga distributor langsung tanpa perantara untuk efisiensi biaya Anda.</p>
          </div>
        </div>
        ...
        <div className="bg-zinc-900 rounded-[4rem] p-12 md:p-24 text-center text-white overflow-hidden relative">
           ...
           <h2 className="text-3xl md:text-5xl font-black mb-8 tracking-tight">Butuh Penawaran untuk Area Serpong?</h2>
           <p className="text-zinc-400 mb-12 max-w-xl mx-auto">Tim sales kami siaga membantu memberikan simulasi biaya dan spesifikasi pallet terbaik untuk kebutuhan bisnis Anda.</p>
