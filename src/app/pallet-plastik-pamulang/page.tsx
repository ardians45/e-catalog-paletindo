    ...
    <div className="w-full bg-[#fcfcfd] min-h-screen pt-28 pb-32">
      <div className="container mx-auto px-4 sm:px-6 lg:px-12">
        ...
        <h1 className="text-4xl md:text-6xl font-black text-zinc-900 leading-tight mb-8 tracking-tighter">
          Palet Plastik <span className="text-[#D4A373]">Pamulang.</span>
        </h1>
        
        <div className="prose prose-lg prose-zinc max-w-4xl mb-20 text-zinc-600 font-light">
          <p>
            Memenuhi kebutuhan logistik di wilayah Pamulang, PT Paletindo Prakarsa Unggul menyediakan berbagai jenis <strong>palet plastik Pamulang</strong> yang tangguh dan tahan lama. Kami melayani pengiriman ke Benda Baru, Pondok Cabe, hingga Pamulang Barat dan Timur.
          </p>
          <p>
            Pallet kami dirancang untuk penggunaan industrial berat, mudah dibersihkan, dan tahan terhadap kelembaban, menjadikannya pilihan yang lebih unggul dibandingkan pallet kayu tradisional untuk pergudangan di wilayah Pamulang.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-32">
          <div className="bg-white p-10 rounded-[2.5rem] border border-zinc-100 shadow-sm">
            ...
            <h3 className="text-xl font-bold mb-4">Pengiriman Pamulang</h3>
            <p className="text-sm text-zinc-500 leading-relaxed">Layanan pengiriman cepat ke seluruh kelurahan di wilayah Pamulang.</p>
          </div>
          <div className="bg-white p-10 rounded-[2.5rem] border border-zinc-100 shadow-sm">
            <ShieldCheck className="w-10 h-10 text-[#D4A373] mb-6" />
            <h3 className="text-xl font-bold mb-4">Higienis & Bersih</h3>
            <p className="text-sm text-zinc-500 leading-relaxed">Cocok untuk industri yang mengutamakan kebersihan standar tinggi.</p>
          </div>
          <div className="bg-white p-10 rounded-[2.5rem] border border-zinc-100 shadow-sm">
            <Star className="w-10 h-10 text-[#D4A373] mb-6" />
            <h3 className="text-xl font-bold mb-4">Stok Melimpah</h3>
            <p className="text-sm text-zinc-500 leading-relaxed">Ribuan unit siap kirim untuk mendukung operasional bisnis Anda.</p>
          </div>
        </div>
        ...
        <div className="bg-zinc-900 rounded-[4rem] p-12 md:p-24 text-center text-white overflow-hidden relative">
           ...
           <h2 className="text-3xl md:text-5xl font-black mb-8 tracking-tight">Butuh Palet Plastik di Pamulang?</h2>
           <p className="text-zinc-400 mb-12 max-w-xl mx-auto">Segera dapatkan kuotasi harga pallet plastik untuk area Pamulang dengan menghubungi tim kami.</p>
           <div className="flex flex-col sm:flex-row gap-4 justify-center">
             <a href="https://wa.me/6287877662097" className="px-10 py-5 bg-[#D4A373] text-zinc-900 rounded-2xl font-bold hover:bg-[#C19263] transition-all flex items-center justify-center gap-3">
               <MessageCircle className="w-5 h-5" /> Hubungi Sales WA
             </a>
